      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-travel-mustard hover:bg-travel-mustard/80 text-travel-dark mx-0 text-sm py-0 px-[10px] rounded-md font-normal">
            ...
            handleOpenDetails(point);
              ...
              <CardContent>
                ...
                {(point.planned_visit_date || point.plannedVisitDate) && <div className="flex items-start gap-2 mt-2">
                    ...
                    <span className="text-sm text-travel-dark/70">
                      Visita planejada: {format(new Date(point.planned_visit_date || point.plannedVisitDate!), 'PPP', {
                locale: ptBR
              })}
                    </span>
                  </div>}
