...
export function TopNavigationMenu() {
  ...
  return (
    ...
    >
      <NavigationMenu className="bg-white/90 backdrop-blur-sm shadow-md p-1 border border-travel-light-mustard/50 my-4 px-[20px] rounded-full mx-0">
                      ...
                      <Link to={item.to}>
                        <div 
                          className={cn(
                            ...
                            isActive 
                              ? "bg-travel-mustard text-travel-dark scale-110 shadow-sm" 
